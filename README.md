...
```javascript
import gapxsumkbn from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapxsumkbn@v0.0.9-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapxsumkbn@v0.0.9-esm/index.mjs';
```
